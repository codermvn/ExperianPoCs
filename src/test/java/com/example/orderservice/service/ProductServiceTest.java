 ...
 * 
 * import com.example.orderservice.model.InputProduct; import
 * com.example.orderservice.model.Product; import
 * com.example.orderservice.repository.ProductRepository;
 * 
 ...
 * 
 * //@Test void testGetProductById() {
 * 
 * int id=1; Product mockproduct = new Product(); mockproduct.setProductId(id);
 * mockproduct.setProductName("Laptop"); mockproduct.setCompany("HP");
 * mockproduct.setInventory(10); BigDecimal val = new BigDecimal(50000);
 ...
 * inputProduct.setProductName("Laptop"); inputProduct.setCompany("HP");
 * inputProduct.setInventory(10); BigDecimal val = new BigDecimal(20000);
 ...
 * 
 * @Test void testDeductInventory() {}
 * 
 * //@Test void testCreateProduct() { InputProduct inputProduct = new
 * InputProduct(); inputProduct.setProductName("Laptop");
 * inputProduct.setCompany("HP"); inputProduct.setInventory(10); BigDecimal val
 * = new BigDecimal(50000); inputProduct.setProductPrice(val);
 * 
 * Product product = new Product();
 * 
