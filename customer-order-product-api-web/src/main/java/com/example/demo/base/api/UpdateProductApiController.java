...
@Controller
public class UpdateProductApiController implements UpdateProductApi {
    ...
    public UpdateProductApiController(ObjectMapper objectMapper, HttpServletRequest request) {
