...
@Controller
public class DeleteProductApiController implements DeleteProductApi {
    ...
    public DeleteProductApiController(ObjectMapper objectMapper, HttpServletRequest request) {
