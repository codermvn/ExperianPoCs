...
@Controller
public class GetAllProductsApiController implements GetAllProductsApi {
    ...
    public GetAllProductsApiController(ObjectMapper objectMapper, HttpServletRequest request) {
