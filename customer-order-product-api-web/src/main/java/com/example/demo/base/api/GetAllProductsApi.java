...
@Api(value = "getAllProducts", description = "the getAllProducts API")
public interface GetAllProductsApi {

    Logger log = LoggerFactory.getLogger(GetAllProductsApi.class);
    ...
    @ApiOperation(value = "get all products", nickname = "getAllProductsGet", notes = "you can fetch all the available orders ", response = Product.class, responseContainer = "List", tags={ "products", })
    @ApiResponses(value = { 
    ...
    default ResponseEntity<List<Product>> getAllProductsGet() {
        if(getObjectMapper().isPresent() && getAcceptHeader().isPresent()) {
            ...
            log.warn("ObjectMapper or HttpServletRequest not configured in default GetAllProductsApi interface so no example is generated");
        }
