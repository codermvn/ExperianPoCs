...
@Controller
public class CreateCustomerApiController implements CreateCustomerApi {
    ...
    public CreateCustomerApiController(ObjectMapper objectMapper, HttpServletRequest request) {
